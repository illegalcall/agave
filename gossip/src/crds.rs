...
mod tests {
    use {
        super::*,
        crate::crds_data::{LowestSlot, new_rand_timestamp},
        rand::{Rng, rng},
    ...
    fn test_get_shred_version() {
        ...
        let val = CrdsData::LowestSlot(0, LowestSlot::new(pubkey, rng.random(), timestamp()));
        ...
        crds.remove(&CrdsValueLabel::LowestSlot(pubkey), timestamp());
